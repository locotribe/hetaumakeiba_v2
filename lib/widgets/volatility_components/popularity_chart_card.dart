...
class PopularityChartCard extends StatelessWidget {
  final PopularityAnalysisResult result;

  const PopularityChartCard({super.key, required this.result});
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (value, meta) {
                          int pop = value.toInt();
                          if (pop >= 1 && pop <= 5) {
                            int total = result.totalCounts[pop] ?? 0;
                            return Padding(
